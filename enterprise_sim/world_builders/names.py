...
FIRST_NAMES: tuple[str, ...] = (
    "Ada", "Ben", "Chen", "Diego", "Elena", "Farah", "Grace", "Hiro",
    "Ines", "Jamal", "Kira", "Liam", "Mira", "Noor", "Omar", "Priya",
    "Quinn", "Rosa", "Sven", "Tara", "Ugo", "Vera", "Wes", "Xian",
    "Yuki", "Zara", "Aria", "Bodhi", "Cleo", "Dario", "Esme", "Felix",
    "Gita", "Hugo", "Isla", "Jonas", "Kemal", "Lena", "Marco", "Nadia",
)
LAST_NAMES: tuple[str, ...] = (
    "Acosta", "Bauer", "Cho", "Diaz", "Engel", "Fontaine", "Greco", "Haddad",
    "Ibarra", "Jain", "Kowalski", "Lindqvist", "Moreau", "Nakamura", "Okafor",
    "Pereira", "Quintero", "Rossi", "Singh", "Tanaka", "Ueda", "Volkov",
    "Wang", "Xu", "Yamamoto", "Zhang", "Andersson", "Brandt", "Costa", "Dubois",
    "Eriksen", "Ferreira", "Gallo", "Hassan", "Ito", "Jensen", "Kaur", "Laurent",
    "Mehta", "Novak",
)
